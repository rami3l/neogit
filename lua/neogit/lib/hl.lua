...
local function make_palette()
  ...
  return {
    ...
    line_orange = orange:shade(-0.6):set_saturation(0.4):to_css(),
...
function M.setup()
  ...
  hl_store = {
    ...
    NeogitDiffConflictSection = { bg = palette.line_orange, fg = palette.bg_orange },
    NeogitDiffConflictHeader = { bg = palette.bg1, fg = palette.bg3 },
    NeogitDiffConflictSectionHighlight = { bg = palette.line_orange, fg = palette.orange },
    NeogitDiffConflictHeaderHighlight = { bg = palette.bg3, fg = palette.bg1 },
